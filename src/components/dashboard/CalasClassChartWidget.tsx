...
export const MOCK_CLASS_STATS: ClassStatItem[] = [
...
export const CalasClassChartCard: React.FC = () => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              <span>📊</span> Grafik Distribusi Calas per Kelas Kuliah
            </h2>
...
export const CalasClassTableCard: React.FC = () => {
  const tableColumns = [
    {
      key: 'kodeKelas',
