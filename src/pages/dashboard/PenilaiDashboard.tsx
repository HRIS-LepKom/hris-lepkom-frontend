    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-lepkom-blue to-indigo-900 text-white rounded-2xl p-6 sm:p-8 shadow-md flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Button
            variant="secondary"
            className="bg-white text-lepkom-blue hover:bg-gray-100 border-none font-bold self-start sm:self-center shadow-xs"
        ...
        <Card header="⚡ Pintasan Aksi Penilai">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Button
              variant="secondary"
              className="w-full justify-start py-4 h-auto hover:border-lepkom-blue/40 transition-all"
              onClick={() => navigate('/penilai/my-assignments')}
            >
