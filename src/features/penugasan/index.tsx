...
import { penugasanMenu } from '@/routes/config/menu/penugasan';

const PenugasanDashboard = () => {
  ...
  const allowedMenus = penugasanMenu.children.filter((menu) => {
  ...
  return (
    <ContentLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Menu Penugasan</h1>
...
export default PenugasanDashboard;
