...
import { jadwalMenu } from '@/routes/config/menu'; 
...
const jadwalDashboard = () => {
  ...
  const allowedMenus = jadwalMenu.children.filter((menu) => {
  ...
  return (
    <ContentLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Menu Jadwal</h1>
